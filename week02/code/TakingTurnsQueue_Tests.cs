...
// Run 10 times.
// Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
// Defect(s) Found: The code did not re-add people with 0 turns to the queue, even though 0 means infinite turns.
...
// Defect(s) Found: The code did not re-add people with negative turns to the queue, even though negative turns mean infinite turns.
